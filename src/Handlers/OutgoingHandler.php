...
#[AsCommand(name: 'app.command_handler.outgoing')]
class OutgoingHandler extends Command
{
    ...
    {
        $message = $this->entityManager->getRepository(OutgoingMessage::class)->find($input->getArgument('id'));
        if ($message) {
