...
#[AsCommand(name: 'app.command_handler.task')]
class TaskHandler extends Command
{
    ...
    {
        $message = $this->entityManager->getRepository(TaskMessage::class)->find($input->getArgument('id'));
        if ($message) {
